...
export const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: [
      ...
      'This is the detail that quietly breaks cocoa programmes. A co-op collecting points for every farm is fine right up until a farm turns out to be 4.2 ha, and then the point that was collected two seasons ago is not the evidence you need. Grovetrace validates geometry on the way in — validity, hemisphere and range checks, duplicates, overlaps — so the gaps surface months before a submission window rather than inside one.',
    ],
  },
  {
    q: 'Do I have to replace the systems I already use?',
    a: [
      'No, and you should not have to. Grovetrace connects to what you run — ERP exports, field-data platforms, co-op spreadsheets, CSV — and maps each source once onto its own model: farmers to suppliers, plots to land plots, lots to batches.',
